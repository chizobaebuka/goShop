                ...
                <div className="container-xxl">
                    <div className="row">
                        ...
                        <div className="text-end text-white">
                            <p>Hotline: <a className='text-white' href="tel: +1 (888) 1338 9183"> +1 (888) 1338 9183 </a> </p>
                        </div>
                    </div>
                </div>
            </header>
                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-5">
                            <div class="input-group">
                                ...
                                <span class="input-group-text py-3" id="basic-addon2"><BsSearch className='fs-6'/></span>
                            </div>
                        </div>
                        <div className="col-5">
